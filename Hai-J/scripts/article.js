...
Article.prototype.toHtml = function() {
    ...
    const template = $('#blog-template').html(); // Get the template
    const templateRender = Handlebars.compile(template); // Compiling
...
// Utilizing a parenthese converts it into a function which is the new standard of ES6.
